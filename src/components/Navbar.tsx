      ...
      <div className="max-w-7xl mx-auto px-2 sm:px-4">
        <div className="flex flex-wrap items-center h-20 gap-x-4 gap-y-2">
          ...
          <div className="flex-1 flex justify-center min-w-0">
            <div className="hidden lg:flex items-center space-x-4 min-w-0 max-w-full overflow-x-auto scrollbar-thin scrollbar-thumb-primary-500/20 scrollbar-track-transparent flex-shrink-0 whitespace-nowrap">
              {navMenu.map((item) => (
                <Link 
                  key={item.href}
                  href={item.href} 
