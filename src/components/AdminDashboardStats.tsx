    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
      <div className="glass-card rounded-2xl p-8 border border-primary-500/30 hover:scale-105 transition-all duration-300 group">
        <div className="flex items-center">
          ...
          <div className="ml-6">
            <p className="text-sm font-semibold text-primary-400 uppercase tracking-wider">{t('admin.dashboard.totalProjects')}</p>
      ...
      <div className="glass-card rounded-2xl p-8 border border-primary-500/30 hover:scale-105 transition-all duration-300 group">
        <div className="flex items-center">
          ...
          <div className="ml-6">
            <p className="text-sm font-semibold text-primary-400 uppercase tracking-wider">{t('admin.dashboard.totalTestimonials')}</p>
      ...
      <div className="glass-card rounded-2xl p-8 border border-primary-500/30 hover:scale-105 transition-all duration-300 group">
        <div className="flex items-center">
          ...
          <div className="ml-6">
            <p className="text-sm font-semibold text-primary-400 uppercase tracking-wider">{t('admin.dashboard.totalMessages')}</p>
      ...
      <div className="glass-card rounded-2xl p-8 border border-primary-500/30 hover:scale-105 transition-all duration-300 group">
        <div className="flex items-center">
          ...
          <div className="ml-6">
            <p className="text-sm font-semibold text-primary-400 uppercase tracking-wider">{t('admin.dashboard.pendingTestimonials')}</p>
