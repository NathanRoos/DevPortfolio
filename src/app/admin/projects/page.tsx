                    ...
                    <div className="flex justify-between items-start mb-6">
                      ...
                      {editState && editState.id === project.id && (
                        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-70">
                          <div className="glass-card p-8 rounded-2xl w-full max-w-lg relative animate-fade-in shadow-2xl border border-primary-500/40 overflow-y-auto max-h-screen" style={{ minWidth: '320px' }}>
